...
def carregar_dados_do_mongo():
    ...
    # collection_blocos = db["casosCorrigidosBlocos"]  # ❌ Comentado para não usar blocos

    dados = []

    # Parte 1: casosCorrigidos (casos completos)
    ...
    # Parte 2: casosCorrigidosBlocos (comentado para desativar)
    """
